...
def train_model(source_data, target_data, encoder_inputs, encoder_inputs_length, decoder_targets, train_op, loss, decoder_prediction, sess, loss_track, parameters, saver, alphabet_and_morph_tags, args, summ, writer, exp_num):
    patience_counter = 0
...
def main():
    ...
    # GLOBAL CONTANTS (default parameters)
    ...
    # run experiments
    for exp_num in range(0,int(args.experiment_num)):
        ...
        with tf.Session() as sess:
            ...
            #train it 
            train_op = tf.train.AdamOptimizer(parameters.learning_rate).minimize(loss)
            ...
            try:
                ...
                train_model(source_data, target_data, encoder_inputs, encoder_inputs_length, decoder_targets, train_op, loss, decoder_prediction, sess, loss_track, parameters,saver, alphabet_and_morph_tags, args, summ, writer, exp_num)
