...
def main():
	...
	# uncomment this line to train on the best parametercombination
        ...
        directory_param = './parameters'
        if not os.path.exists(directory_param):
                os.makedirs(directory_param)

        # create output directory if not existing, contains Tensorboard outputs
        directory_visual = './output'
        if not os.path.exists(directory_visual):
                os.makedirs(directory_visual)
